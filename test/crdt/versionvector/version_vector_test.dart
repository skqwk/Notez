...
void main() {
  ...
  group('Векто версий должен расчитывать объединение (merge) векторов версий',
    ...
    test('когда векторы версий оба содержат уникальные значения', () {
      ...
      VersionVector local = VersionVector(
          [HybridTimestamp.parse(time1), HybridTimestamp.parse(time2)]);

      String node3 = "3f570240-caa4-47e5-9be0-13df707a1dd8";
      String time3 =
          "2023-04-26T04:46:45.680Z-0000-3f570240-caa4-47e5-9be0-13df707a1dd8";

      String node4 = "a69c4a8f-caa6-4ae6-8f03-cb75561400d6";
      String time4 =
          "2023-04-26T04:46:12.680Z-0000-a69c4a8f-caa6-4ae6-8f03-cb75561400d6";

      VersionVector remote = VersionVector(
          [HybridTimestamp.parse(time3), HybridTimestamp.parse(time4)]);
    ...
    test('когда на сервере/клиенте содержится неактуальная информация', () {
      ...
      String remoteTime1 =
          "2023-04-27T04:46:45.680Z-0000-556a4927-b728-4c90-8d87-f14f26a2b5ee";
      String remoteTime2 =
          "2023-04-18T04:46:12.680Z-0000-4dbe409c-22ed-4783-a0fc-e89be8744c9e";
      ...
      expect(
          HybridTimestamp.parse(localTime1)
              .happenedBefore(HybridTimestamp.parse(remoteTime1)),
          true);
      expect(
          HybridTimestamp.parse(remoteTime2)
              .happenedBefore(HybridTimestamp.parse(localTime2)),
          true);
  ...
  test('Должен корректно преобразовываться из списка json', () {
    ...
    VersionVector result =
        VersionVector.fromJson(jsonDecode(fixture('version_vector.json')));
  ...
  test('Должен корректно преобразовываться в список json', () {
    // GIVEN
    String remoteTime1 =
        "2023-04-27T04:46:45.680Z-0000-556a4927-b728-4c90-8d87-f14f26a2b5ee";
    String remoteTime2 =
    ...
    // WHEN
    List<String> actual = versionVector.toJson();

    // THEN
    expect(actual, [remoteTime1, remoteTime2]);
  });
}
